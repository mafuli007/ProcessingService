 ...
 * 
 */
public class AtmosphericDensityData extends BrazilDataFile implements IBrazilDataPrcoess {

	public AtmosphericDensityData(String filename) {
		super(filename);
	...
	public void process() throws ProcessException{
		...
		/**
		 * 3. if you define other functions, they should be run at here, before
		 * or after.
		 */
	}
